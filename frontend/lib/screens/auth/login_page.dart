              ...
              child: Form(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Padding(
                    ...
                    child: Image.asset('assets/images/logo.png', height: 72, errorBuilder: (_, __, ___) => const Icon(Icons.calendar_today, size: 56)),
                  ),
                  Text('Đăng nhập', style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold)),
