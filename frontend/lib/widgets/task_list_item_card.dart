...
class TaskListItemCard extends StatelessWidget {
  ...
  Widget _priorityChip(String priority, ColorScheme cs) {
    ...
    return Chip(label: Text(label), visualDensity: VisualDensity.compact, materialTapTargetSize: MaterialTapTargetSize.shrinkWrap, backgroundColor: color.withValues(alpha: 0.1), labelStyle: TextStyle(color: color));
  }
