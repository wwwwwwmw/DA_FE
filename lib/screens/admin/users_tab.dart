...
class _AdminUsersTabState extends State<AdminUsersTab> {
  ...
  String _query = '';
  String _roleFilter = 'all'; // all | admin | manager | employee
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Tải người dùng thất bại: $e')));
      }
    } finally {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      onChanged: (v) =>
                          setStateDialog(() => role = v ?? 'employee'),
                    ),
  ...
  Future<void> _showEdit(UserModel user) async {
    ...
    DepartmentModel? dep = api.departments.firstWhere(
      ...
      orElse: () => DepartmentModel(id: '', name: ''),
    ); // placeholder null
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      controller: passCtrl,
                      decoration: const InputDecoration(
                        labelText: 'Mật khẩu (đổi nếu nhập)',
                      ),
                      obscureText: true,
                    ),
                    DropdownButtonFormField<String>(
  ...
  Future<void> _unlockAccount(UserModel user) async {
    final api = context.read<ApiService>();
    final ok = await showDialog<bool>(
      context: context,
