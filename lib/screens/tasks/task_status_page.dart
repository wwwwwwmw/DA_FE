...
class _TaskStatusPageState extends State<TaskStatusPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final sections = allZero
        ? [PieChartSectionData(value: 1, color: Colors.grey.shade300, title: '0', radius: 60, titleStyle: const TextStyle(color: Colors.black54, fontWeight: FontWeight.bold))]
        : [
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            Expanded(
              child: DropdownButtonFormField<String>(
                ...
                isDense: true,
                decoration: const InputDecoration(labelText: 'Dự án', border: OutlineInputBorder(), isDense: true),
                items: [
          ...
          const SizedBox(height: 16),
          if (_selectedStatus != null) Text('Lọc trạng thái: ${_localized(_selectedStatus!)}', style: Theme.of(context).textTheme.titleMedium),
